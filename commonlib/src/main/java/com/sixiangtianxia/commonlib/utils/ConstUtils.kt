...
class ConstUtils {
    ...
    companion object {
        ...
        val REGEX_MOBILE_EXACT =
            "^((13[0-9])|(14[0,5-8])|(15[0-3,5-9])|(17[0,3-8])|(18[0-9])|(19[0-3,5-9])|(166))\\d{8}$"
        /**
         * 正则：电话号码
         */
         ...
         */
        val REGEX_USERNAME = "^[\\w\\u4e00-\\u9fa5]{1,8}(?<!_)$"

        /**
         * 正则: 密码
         */
        val REGEX_PWD = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,20}$"

        /**
         * 正则: 支付宝账户
         */
        val REGES_ALI_ACCOUNT = "/^(?:\\w+\\.?)*\\w+@(?:\\w+\\.)+\\w+|\\d{9,11}$/"
