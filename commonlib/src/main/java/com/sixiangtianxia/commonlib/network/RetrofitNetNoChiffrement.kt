...
class RetrofitNetNoChiffrement {

    companion object {
        // 读取超时，单位:毫秒
        val READ_TIME_OUT: Long = 10000 // (10*1000)
        // 连接超时,单位:毫秒
        val CONNECT_TIME_OUT: Long = 10000 // (10*1000)
        var mUseCache = true

        private val sRetrofitManager = SparseArray<RetrofitNetNoChiffrement>(HostType.TYPE_COUNT * 2)
        /*************************
         * 缓存设置
         *********************/
        /*
        ...
        */
        ...
        fun getDefault(hostType: Int): NetWorkService {
            ...
            if (retrofitNet == null) {
                retrofitNet = RetrofitNetNoChiffrement(hostType)
    ...
    private constructor(hostType: Int) {
        ...
        val cache = Cache(cacheFile, 1024 * 1024 * 10)// 100Mb
        // 增加头部信息
