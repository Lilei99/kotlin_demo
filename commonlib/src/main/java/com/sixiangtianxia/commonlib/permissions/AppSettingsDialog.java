...
public class AppSettingsDialog implements Parcelable {
    ...
    AlertDialog showDialog(DialogInterface.OnClickListener positiveListener,
        ...
        if (mThemeResId > 0) {
            ...
            builder = new AlertDialog.Builder(mContext, R.style.Dialog_Alert_Self);
        }
        return builder
                .setCancelable(false)
                .setTitle(mTitle)
    ...
    public static class Builder {
        ...
        public AppSettingsDialog build() {
            ...
            mPositiveButtonText = TextUtils.isEmpty(mPositiveButtonText) ?
                    mContext.getString(R.string.text_agree) : mPositiveButtonText;
            mNegativeButtonText = TextUtils.isEmpty(mNegativeButtonText) ?
                    mContext.getString(R.string.text_cancel) : mNegativeButtonText;
