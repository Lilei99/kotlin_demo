...
class PermissionRequest private constructor(
    ...
    class Builder {
         ...
         */
        constructor(
            fragment: android.app.Fragment, requestCode: Int,
            @Size(min = 1) vararg perms: String
        ) {
            mHelper = PermissionHelper.newInstance(fragment)
            mRequestCode = requestCode
        ...
        fun build(): PermissionRequest {
            ...
            if (mPositiveButtonText == null) {
                mPositiveButtonText = mHelper.context.getString(R.string.text_agree)
            }
            if (mNegativeButtonText == null) {
                mNegativeButtonText = mHelper.context.getString(R.string.text_cancel)
            }
