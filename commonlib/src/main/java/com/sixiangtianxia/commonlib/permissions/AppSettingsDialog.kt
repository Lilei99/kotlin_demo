...
class AppSettingsDialog : Parcelable {
    ...
    private fun startForResult(intent: Intent) {
        if (mActivityOrFragment is Activity) {
            ...
            (mActivityOrFragment as android.app.Fragment).startActivityForResult(
                intent,
                mRequestCode
            )
        }
    ...
    internal fun showDialog(
        ...
        if (mThemeResId > 0) {
            ...
            builder = AlertDialog.Builder(mContext!!, R.style.Dialog_Alert_Self)
        }
        return builder
            .setCancelable(false)
            .setTitle(mTitle)
    ...
    class Builder {
        ...
        fun build(): AppSettingsDialog {
            ...
            mPositiveButtonText = if (TextUtils.isEmpty(mPositiveButtonText))
                mContext!!.getString(R.string.text_agree)
            else
                mPositiveButtonText
    ...
    companion object {
     ...
     object CREATOR : Parcelable.Creator<AppSettingsDialog> {
